...
* 模块的提交和更新走pull request

* 提交到联盟的传输模块应包含README，说明在框架内注册传输模块的方法，特别是模块名（例如前述例子中的XYPushModule）。建议参考已有模块的README

* 如果模块不开源，则应向repo提交头文件和预编译好的库文件，并在框架代码中注册该模块

* 如果模块开源且在联盟内维护，则应提交代码作为框架repo的一部分，并在框架代码中注册该模块

* 如果模块开源但由开发者单独维护，则代码不提交到框架repo，也不在框架代码中注册该模块。可申请挂链接
